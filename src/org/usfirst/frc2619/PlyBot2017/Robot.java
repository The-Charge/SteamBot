...
public class Robot extends IterativeRobot {
    ...
    public static boolean  allowDelinearization;
    /**
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        ...
        TheChargeDashboard.putData(driveTrain);
        allowDelinearization = true;
        TheChargeDashboard.putBoolean("Account Delinearization for deadband? ", allowDelinearization);
