...
public class RobotMap {
    ...
    private static int CurrentLimit = 4;// max current on each motor in amps
    ...
    // BEGIN Code added by KAEDON
     ...
     //Set Current Limiting value from int CurrentLimit   
        driveTrainLeftRearMotor.setCurrentLimit(CurrentLimit);
        driveTrainRightRearMotor.setCurrentLimit(CurrentLimit);
        driveTrainLeftFrontMotor.setCurrentLimit(CurrentLimit);
        driveTrainRightFrontMotor.setCurrentLimit(CurrentLimit);
