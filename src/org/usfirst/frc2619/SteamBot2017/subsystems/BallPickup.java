...
public class BallPickup extends Subsystem {
	private final static double SPEED_P_CONSTANT = 0.0;
    ...
    public void writeDefaultDashboardValues() {
    	TheChargeDashboard.putNumber("PickupSpeedP", SPEED_P_CONSTANT);
    	TheChargeDashboard.putNumber("PickupSpeedI", SPEED_I_CONSTANT);
		TheChargeDashboard.putNumber("PickupSpeedD", SPEED_D_CONSTANT);
		TheChargeDashboard.putNumber("PickupSpeedF", SPEED_F_CONSTANT);
	}

	public void readDashboardControlValues() {
		SpeedP = SmartDashboard.getNumber("PickupSpeedP", SPEED_P_CONSTANT);
		SpeedI = SmartDashboard.getNumber("PickupSpeedI", SPEED_I_CONSTANT);
		SpeedD = SmartDashboard.getNumber("PickupSpeedD", SPEED_D_CONSTANT);
		SpeedF = SmartDashboard.getNumber("PickupSpeedF", SPEED_F_CONSTANT);
