...
public class CANLights extends Subsystem {
	...
	public void displayCANLightValues(){
		...
		SmartDashboard.putInt("CANLightRed", 0);
		SmartDashboard.putInt("CANLightGreen", 0);
		SmartDashboard.putInt("CANLightBlue", 0);
		
	}
	
public void displayCANLightValues(int r, int g, int b){
		
		SmartDashboard.putInt("CANLightRed", r);
		SmartDashboard.putInt("CANLightGreen", g);
		SmartDashboard.putInt("CANLightBlue", b);
...
public void blink(){
	...
	cANLight.writeRegister(1, 0.5, SmartDashboard.getInt("CANLightRed"), SmartDashboard.getInt("CANLightGreen"), SmartDashboard.getInt("CANLightBlue")); //current
    ...
    public void initDefaultCommand() {
        ...
        setDefaultCommand(new RunCANLights());
