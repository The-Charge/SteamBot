...
public class DriveTrain extends Subsystem {
	...
	public void run(double leftSpeed, double rightSpeed) {
		...
		//rightFrontMotor.changeControlMode(ControlMode.PercentOutput);
	...
	public void dXF_MM(double acceleration, double velocity, double distance) {
		...
		leftFrontMotor.changeControlMode(WPI_TalonSRX.TalonControlMode.MotionMagic);
		rightFrontMotor.changeControlMode(WPI_TalonSRX.TalonControlMode.MotionMagic);
