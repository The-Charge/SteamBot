...
public class RopeClimber extends Subsystem {
	...
	public void setMotorModes() {
		ropeMotor1.set(ControlMode.PercentOutput, 0);
		ropeMotor2.set(ControlMode.PercentOutput, 0);
	}
	...
	public void currentLimiting() {
		ropeMotor1.configContinuousCurrentLimit((int) CURRENT_LIMIT, RobotMap.TIMEOUT_MS);
		ropeMotor1.enableCurrentLimit(true);
		ropeMotor2.configContinuousCurrentLimit((int) CURRENT_LIMIT, RobotMap.TIMEOUT_MS);
