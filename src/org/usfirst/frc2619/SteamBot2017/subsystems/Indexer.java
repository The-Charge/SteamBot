...
public class Indexer extends Subsystem {
	...
	public void readDashboardControlValues() {
		...
		// set CANTalon PIDs
		indexerMotor.config_kP(1, SpeedP, RobotMap.TIMEOUT_MS);
		indexerMotor.config_kI(1, SpeedI, RobotMap.TIMEOUT_MS);
		indexerMotor.config_kD(1, SpeedD, RobotMap.TIMEOUT_MS);
		indexerMotor.config_kF(1, SpeedF, RobotMap.TIMEOUT_MS);
	}
	...
	public void set(double percentSpeed) {
		...
		indexerMotor.set(ControlMode.Velocity, MAX_TICKS_PER_SECOND * percentSpeed);
	}
