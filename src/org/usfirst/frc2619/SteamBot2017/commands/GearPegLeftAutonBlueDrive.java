 ...
 *
 */
public class GearPegLeftAutonBlueDrive extends CommandGroup {


    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=PARAMETERS
    public GearPegLeftAutonBlueDrive() {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=COMMAND_DECLARATIONS
		...
		addSequential(new DriveXFeetMM(8.5)); //9
		...
		addSequential(new DriveXFeetMM(29));
		addSequential(new TurnNDegreesAbsolutePID(0));
    } 
}
