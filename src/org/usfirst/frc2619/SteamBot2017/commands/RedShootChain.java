 ...
 *
 */
public class RedShootChain extends CommandGroup {


    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=PARAMETERS
    public RedShootChain() {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=PARAMETERS
    	...
    	addSequential(new TurnNDegreesRelativePID(1));
    	addSequential(new DriveXFeetMM(2000, 1000, 9));
    	addSequential(new DriveToCurrent(0.3));
    	addParallel(new RunShooter());
		addSequential(new DriveXSeconds(0.7));
