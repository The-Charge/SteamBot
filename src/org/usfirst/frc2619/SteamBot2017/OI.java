...
public class OI {
    ...
    public JoystickButton climbRopeHalfSecBtn;
    ...
    public OI() {
        ...
        climbRopeHalfSecBtn = new JoystickButton(buttonBox, 3);
        climbRopeHalfSecBtn.whenPressed(new ClimbRopeTimed(.5));
        climbRopeBtn = new JoystickButton(buttonBox, 2);
        ...
        SmartDashboard.putData("RunServo", new RunServo());
        SmartDashboard.putData("ESForward", new ESForward());
        SmartDashboard.putData("ESOff", new ESOff());
        SmartDashboard.putData("RunShooter", new RunShooter());
        SmartDashboard.putData("ClimbRope", new ClimbRope());
        SmartDashboard.putData("ClimbRopeTimed: halfSec", new ClimbRopeTimed(.5));
