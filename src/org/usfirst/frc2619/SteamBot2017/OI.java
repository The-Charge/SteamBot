...
public class OI {
	...
	public OI() {
        ...
        closeDoorsBtn = new JoystickButton(buttonBox, 10);
        closeDoorsBtn.whenReleased(new CloseDoors());
        openDoorsBtn = new JoystickButton(buttonBox, 10);
        ...
        closePlungeBtn = new JoystickButton(buttonBox, 9);
        closePlungeBtn.whenReleased(new ClosePlunge());
        openPlungeBtn = new JoystickButton(buttonBox, 9);
        ...
        SmartDashboard.putData("IndexAndAgitate", new IndexAndAgitate());*/
