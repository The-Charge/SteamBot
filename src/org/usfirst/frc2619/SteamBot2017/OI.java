...
public class OI {
	...
	public OI() {
        ...
        SmartDashboard.putData("BlueShoot", new BlueShoot());
        SmartDashboard.putData("RedShoot", new RedShoot());
        SmartDashboard.putData("BlueShootChain", new BlueShootChain());
        SmartDashboard.putData("RedShootChain", new RedShootChain());
